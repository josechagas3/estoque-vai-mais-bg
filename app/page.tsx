...
export default function Page() {
  ...
  return <div className="app-shell">
    ...
    <main className="content">{view === 'dashboard' && <Dashboard products={products} lowStock={lowStock} movements={movements} onNavigate={go} />}
      ...
      {(view === 'entry' || view === 'exit') && <MovementForm type={view === 'entry' ? 'Entrada' : 'Saída'} products={products} category={selectedCategory} selected={selectedProduct} quantity={quantity} setCategory={(value) => { setSelectedCategory(value); setSelectedProduct('') }} setSelected={setSelectedProduct} setQuantity={setQuantity} submit={registerMovement} />}
      ...
      {view === 'purchase' && <Purchase products={products} movements={weekMovements} category={purchaseCategory} setCategory={setPurchaseCategory} quantities={purchaseQuantities} setQuantities={setPurchaseQuantities} confirm={confirmPurchase} />}
